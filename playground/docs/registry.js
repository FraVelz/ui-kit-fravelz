...
export const COMPONENT_DOCS = [
  ...
  },
  {
    ...
    props: [
      ...
      { name: "type", type: '"info" | "success" | "warning" | "error"', default: '"info"', description: "Estilo e icono." },
      { name: "title", type: "string", default: "null", description: "Título opcional." },
      { name: "dismissible", type: "boolean", default: "false", description: "Muestra botón cerrar." },
      { name: "onDismiss", type: "() => void", default: "null", description: "Callback al cerrar." },
  ...
  },
  {
    ...
    props: [
      ...
      { name: "variant", type: '"cyan" | "purple" | "success" | "highlight"', default: '"cyan"', description: "Paleta." },
      { name: "size", type: '"sm" | "md" | "lg"', default: '"md"', description: "Tamaño." },
      { name: "icon", type: "ReactNode", default: "null", description: "Icono SVG opcional a la izquierda." },
  ...
  },
  {
    ...
    props: [
      ...
      { name: "variant", type: '"primary" | "secondary" | "outline" | "ghost"', default: '"primary"', description: "Estilo visual." },
      { name: "size", type: '"sm" | "md" | "lg"', default: '"md"', description: "Padding y tipografía." },
      { name: "className", type: "string", default: '""', description: "Clases extra." },
    ],
  },
  {
    ...
    props: [
      { name: "variant", type: '"default" | "cyan" | "purple" | "dotted" | "gradient"', default: '"default"', description: "Estilo de línea." },
      { name: "orientation", type: '"horizontal" | "vertical"', default: '"horizontal"', description: "Dirección." },
      { name: "label", type: "string", default: "null", description: "Texto entre líneas (solo horizontal)." },
      { name: "size", type: '"sm" | "md" | "lg"', default: '"md"', description: "Margen vertical." },
      { name: "className", type: "string", default: '""', description: "Clases extra." },
    ],
  },
  {
    ...
    props: [
      ...
      { name: "variant", type: "string", default: '"cyan-purple"', description: "cyan-purple, purple-cyan, cyan-only, purple-only, blue-cyan." },
      { name: "as", type: "string", default: '"span"', description: "Elemento HTML (span, h1, p…)." },
      { name: "className", type: "string", default: '""', description: "Clases extra." },
    ],
  },
  {
    ...
    props: [
      ...
      { name: "variant", type: '"default" | "purple" | "minimal"', default: '"default"', description: "Estilo del campo." },
      { name: "size", type: '"sm" | "md" | "lg"', default: '"md"', description: "Tamaño." },
      { name: "label", type: "string", default: "null", description: "Etiqueta superior." },
      { name: "icon", type: "ReactNode", default: "null", description: "Icono SVG a la izquierda." },
      { name: "error", type: "string", default: "null", description: "Mensaje de error bajo el campo." },
      ...
      { name: "...props", type: "input attrs", default: "—", description: "Resto de atributos nativos (value, onChange, type…)." },
    ],
  },
  {
    id: "link",
    ...
    props: [
      ...
      { name: "variant", type: '"default" | "purple" | "accent"', default: '"default"', description: "Color y focus ring." },
      { name: "className", type: "string", default: "—", description: "Clases extra." },
    ],
  },
  {
  ...
  },
  {
    ...
    props: [
      { name: "variant", type: '"default" | "cyan" | "purple" | "subtle"', default: '"default"', description: "Color del borde." },
      { name: "className", type: "string", default: '""', description: "Clases extra." },
    ],
  },
  {
  ...
  },
  {
    ...
    props: [
      ...
      { name: "variant", type: '"cyan" | "purple" | "gray" | "gradient"', default: '"cyan"', description: "Estilo." },
      { name: "removable", type: "boolean", default: "false", description: "Botón cerrar con IconClose." },
      { name: "onRemove", type: "() => void", default: "null", description: "Al pulsar cerrar." },
      { name: "interactive", type: "boolean", default: "false", description: "role=button y tabIndex para foco." },
      { name: "className", type: "string", default: '""', description: "Clases extra." },
    ],
  },
  {
    ...
    props: [
      { name: "children", type: "ReactNode", default: "—", description: "Contenido." },
      { name: "variant", type: "string", default: '"default"', description: "default, secondary, muted, accent, highlight." },
      { name: "size", type: '"sm" | "base" | "lg" | "xl"', default: '"base"', description: "Tamaño." },
      { name: "selectability", type: "string", default: '"auto"', description: "auto, none, text, all." },
      { name: "className", type: "string", default: '""', description: "Clases extra." },
    ],
  },
  {
    ...
    props: [
      ...
      { name: "variant", type: '"default" | "dark" | "highlight"', default: '"default"', description: "Estilo." },
  ...
  },
  {
    ...
    props: [
      ...
      { name: "variant", type: '"primary" | "secondary" | "outline" | "ghost"', default: '"primary"', description: "Igual que Button." },
  ...
  },
  {
    ...
    props: [
      ...
      { name: "title", type: "string", default: "null", description: "Título opcional." },
      { name: "subtitle", type: "string", default: "null", description: "Subtítulo bajo el título." },
      { name: "variant", type: '"default" | "elevated" | "gradient" | "minimal"', default: '"default"', description: "Estilo." },
      { name: "hoverable", type: "boolean", default: "true", description: "Efectos hover en borde/sombra." },
      { name: "className", type: "string", default: '""', description: "Clases extra." },
    ],
  },
  {
    ...
    props: [
      ...
      { name: "language", type: "string", default: '"javascript"', description: "Lenguaje Prism (javascript, bash…)." },
    ],
  ...
  },
  {
    ...
    props: [
      { name: "children", type: "ReactNode", default: "—", description: "Contenido." },
      { name: "size", type: '"sm" | "md" | "lg" | "xl" | "full"', default: '"md"', description: "Ancho máximo." },
      { name: "variant", type: '"default" | "compact" | "relaxed" | "section"', default: '"default"', description: "Padding." },
      { name: "className", type: "string", default: '""', description: "Clases extra." },
    ],
  },
  {
    ...
    props: [
      ...
      { name: "secondaryContent", type: "ReactNode", default: "—", description: "Columna lateral." },
      { name: "hasBorder", type: "boolean", default: "false", description: "Borde exterior opcional." },
    ],
  },
  {
    id: "grid",
    ...
    props: [
      ...
      { name: "cols", type: "number", default: "3", description: "Columnas si responsive=false (1,2,3,4,6)." },
      { name: "gap", type: '"sm" | "md" | "lg" | "xl"', default: '"md"', description: "Espacio entre celdas." },
      { name: "responsive", type: "boolean", default: "true", description: "Grid adaptativo sm→lg." },
      { name: "className", type: "string", default: '""', description: "Clases extra." },
    ],
  },
  {
  ...
  },
  {
    ...
    props: [
      ...
      { name: "showPercentage", type: "boolean", default: "true", description: "Muestra % a la derecha." },
      { name: "variant", type: "string", default: '"cyan"', description: "cyan, purple, gradient, success." },
      { name: "size", type: '"sm" | "md" | "lg" | "xl"', default: '"md"', description: "Altura de la barra." },
      { name: "animated", type: "boolean", default: "true", description: "Transición al cambiar value." },
    ...
    subComponents: [
      ...
      },
      {
        ...
        props: [
          ...
          { name: "alignment", type: '"left" | "center" | "right"', default: '"left"', description: "Alineación." },
        ],
      },
    ],
  },
  {
    ...
    props: [
      { name: "headingLevel", type: '"h1" | "h2" | "h3"', default: "—", description: "Nivel semántico." },
      { name: "children", type: "ReactNode", default: "—", description: "Texto del título." },
      { name: "variant", type: "string", default: '"gradient"', description: "gradient u otro estilo." },
  ...
  },
  {
    ...
    props: [
      { name: "children", type: "ReactNode", default: "—", description: "Contenido (max-w-4xl centrado)." },
      ...
      { name: "variant", type: '"default" | "highlighted" | "minimal" | "elevated"', default: '"default"', description: "Fondo y bordes." },
  ...
  },
  {
    ...
    subComponents: [
      {
        name: "Structure",
        props: [{ name: "children", type: "ReactNode", default: "—", description: "Contenido principal." }],
      },
      {
        name: "CurriculumAside",
        props: [
          { name: "children", type: "ReactNode", default: "—", description: "Items del índice." },
          { name: "curriculumContent", type: "Component", default: "—", description: "Componente lista (p. ej. ol)." },
        ],
      },
      {
        name: "CurriculumFull",
        props: [
          { name: "curriculumContent", type: "Component", default: "—", description: "Índice visible en viewport pequeño." },
        ],
      },
    ],
  ...
  },
  {
    ...
    props: [
      ...
      { name: "variant", type: '"default" | "success" | "warning" | "error"', default: '"default"', description: "Color del borde." },
    ],
  },
  {
    id: "roadmap",
...
export const DOC_BY_ID = Object.fromEntries(COMPONENT_DOCS.map((doc) => [doc.id, doc]));
