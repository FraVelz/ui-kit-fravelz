...
import { Container, GradientText, Text, Title } from "../kit";
import { DOC_SECTIONS, PACKAGE } from "./registry";
import { DocSidebar } from "./ui";
import { DOCS_HOME } from "./paths";
      ...
      <header className="sticky top-0 z-40 border-b border-cyan-500/20 bg-gray-950/95 backdrop-blur">
        <Container className="py-4">
          ...
          <Text variant="muted" className="text-sm !py-0">
            Documentación — <code className="text-cyan-400">{PACKAGE}</code>
          </Text>
        </Container>
      </header>
