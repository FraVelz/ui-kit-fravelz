...
export default function Tag(_ref) {
  ...
  return /*#__PURE__*/<span className={"\n                ".concat(baseClasses, "\n                ").concat(variants[variant], "\n                ").concat(className, "\n            ")}>{children}{removable && /*#__PURE__*/<button onClick={onRemove} className={" ml-1 hover:opacity-75 transition-opacity cursor-pointer text-xs font-bold "}>✕</button>}</span>;
}