...
function CurriculumAside(_ref2) {
  ...
  return (
    /*#__PURE__*/ <aside className={" hidden 2xl:block sticky top-5 self-start w-4/5 min-w-72 "}>
      {
        /*#__PURE__*/ <Title headingLevel={"h2"} className={"select-none"}>
          Curriculum
        </Title>
      }
      {
        /*#__PURE__*/ <CurriculumContent
          className={
...
function CurriculumFull(_ref3) {
  ...
  return (
    /*#__PURE__*/ <>
      {
        /*#__PURE__*/ <Title headingLevel={"h2"} className={"2xl:hidden"}>
          Curriculum
        </Title>
      }
      {
