...
export default function Code(_ref) {
  ...
  return (
    /*#__PURE__*/ <div className={"relative my-4"}>
      {
        /*#__PURE__*/ <button
          onClick={handleCopy}
          className={"\n                    absolute\n                    top-2 right-2\n                    text-xs px-3 py-1.5\n                    rounded-md transition-all\n                    duration-200\n                    cursor-pointer\n                    border border-cyan-500/30\n                    ".concat(
            isCopied
              ...
              : "bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-gray-200 hover:border-cyan-400/40",
            "\n                "
          )}
        >
      ...
      }
      {
        /*#__PURE__*/ <pre
          className={
            " rounded-lg  bg-gray-900  text-sm  overflow-x-auto  p-4 border border-cyan-500/20 hover:border-cyan-500/40 transition-colors "
          }
        >
          {/*#__PURE__*/ <code className={"language-".concat(language)}>{codeContent}</code>}
        </pre>
      }
    </div>
  );
