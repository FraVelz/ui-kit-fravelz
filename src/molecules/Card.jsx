...
export default function Card(_ref) {
  ...
  return /*#__PURE__*/<div className={"\n                ".concat(variants[variant], "\n                p-6\n                rounded-lg\n                transition-all\n                ").concat(className, "\n            ")}>{title && /*#__PURE__*/<>{/*#__PURE__*/<h3 className={" text-lg font-semibold text-cyan-300 mb-2 "}>{title}</h3>}{subtitle && /*#__PURE__*/<p className={"text-gray-400 text-sm mb-4"}>{subtitle}</p>}</>}{/*#__PURE__*/<div className={"text-gray-300"}>{children}</div>}</div>;
}