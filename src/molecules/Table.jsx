...
export var TableHeader = function TableHeader(_ref2) {
  ...
  return (
    /*#__PURE__*/ <thead
      className={
        " bg-gray-800  text-cyan-300 uppercase text-xs font-semibold border-b border-cyan-500/30 "
      }
    >
      {
        /*#__PURE__*/ <tr>
          {headers.map(function (header, index) {
            return (
              /*#__PURE__*/ <th key={index} className={" px-4 py-4 "}>
                {header}
              </th>
            );
          })}
...
export default function ExampleTable() {
  ...
  return (
    /*#__PURE__*/ <Table className={"max-w-4xl mx-auto"}>
      {/*#__PURE__*/ <TableHeader headers={tableHeaders} />}
      {
        /*#__PURE__*/ <tbody>
          {tableData.map(function (user, index) {
            return (
              /*#__PURE__*/ <TableRow key={index}>
                {/*#__PURE__*/ <TableCell>{user.name}</TableCell>}
                {/*#__PURE__*/ <TableCell>{user.email}</TableCell>}
                {/*#__PURE__*/ <TableCell>{user.role}</TableCell>}
                {
                  /*#__PURE__*/ <TableCell>
                    {
                      /*#__PURE__*/ <span
                        className={"px-3 py-1 rounded-full text-xs font-semibold ".concat(
                          user.status === "Active"
