...
export default function Button({ children, className = "", variant = "primary", size = "md", ...props }) {
    return (_jsx("button", { type: "button", className: cn("rounded-full cursor-pointer transition-all duration-300", "outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-950", variant === "outline"
