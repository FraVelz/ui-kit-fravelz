...
function Message(_ref) {
  ...
  React.createElement("h2", {
    className: " text-2xl font-bold mb-4 bg-linear-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent "
  }, title),
  /*#__PURE__*/
  /*#__PURE__*/
  React.createElement("div", {
  ...
  React.createElement("button", {
    onClick: onClose,
    className: " mt-6 bg-gradient-to-r from-cyan-600 to-purple-600 text-white hover:from-cyan-500 hover:to-purple-500 cursor-pointer px-6 py-2 rounded-full transition-all font-semibold shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 "
  }, "Close"))), document.body);
}
