...
export default function CallToAction({ children, className = "", href = "#", icon = null, target = "_self", variant = "primary", }) {
    return (_jsxs("a", { href: href, target: target, draggable: false, className: cn("inline-flex items-center gap-3 px-6 py-3 rounded-full font-semibold transition-all text-lg", "outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-950", variant === "outline"
