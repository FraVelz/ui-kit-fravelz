...
export default function Code({ codeContent, language = "javascript", className, compact = false, }) {
    ...
    const copyButton = (_jsxs("button", { type: "button", onClick: handleCopy, "aria-label": isCopied ? "Copied to clipboard" : "Copy code to clipboard", className: cn("fz-code-block__copy", isCopied && "fz-code-block__copy--copied", compact && "fz-code-block__copy--overlay", "outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/80", "focus-visible:ring-offset-2 focus-visible:ring-offset-white", "dark:focus-visible:ring-offset-gray-950"), children: [_jsx(CopyIcon, { className: "!size-3.5 shrink-0" }), _jsx("span", { children: copyLabel })] }));
