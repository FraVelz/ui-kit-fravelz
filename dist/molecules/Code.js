...
export default function Code(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: cn("absolute top-2 right-2 inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-md transition-all duration-200", "cursor-pointer border border-cyan-500/30", focusCyan, isCopied ? "bg-cyan-600/20 text-cyan-300 border-cyan-400/60" : cn("bg-gray-800 text-gray-300", "hover:bg-gray-700 hover:text-gray-200 hover:border-cyan-400/40"))
